...
/* 将x按由小到大的顺序插入到list */
extern void list_push_order(T list, void *x, int32_t compare(const void *x, const void *y));
...
extern void *list_search_order(T list, void *x, int32_t compare(void const *x, void const *y));
